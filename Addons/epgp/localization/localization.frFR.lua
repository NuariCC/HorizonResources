...
L["Tier Decay"] = "Etage R\195\169duction"
L["Decay EP by %d%% and GP by %d%%?"] = "R\195\169duire les EP par %d%% et les GP par %d%% ?"
L["Decay of EP/GP by %d%%/%d%%"] = "R\195\169duction d'EP/GP par %d%%/%d%%"
