...
L["Tier Decay"] = "Nivel Disminuci\195\179n"
L["Decay EP by %d%% and GP by %d%%?"] = "\194\191Disminuir EP un %d%% y GP un %d%%?"
L["Decay of EP/GP by %d%%/%d%%"] = "Disminuci\195\179n de EP/GP en %d%%/%d%%"
